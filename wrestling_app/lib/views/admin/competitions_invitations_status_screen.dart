...
class _ClubInvitationsScreenState extends State<ClubInvitationsScreen> {
  ...
  final Map<String, String?> _filterMap = {
    ...
    'Refuzate': 'Declined',  // corrected mapping
  };
          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap(
                ...
                spacing: 8,
                runSpacing: 4,
                children: _filterMap.keys.map(_buildFilterButton).toList(),
              ),
            ),
            const SizedBox(height: 16),
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Stare: ${_statusRo(inv.invitationStatus)}',
                          style: const TextStyle(color: Colors.white),
                        ),
                        const SizedBox(height: 4),
                        Text(
